...
\end{verbatim}
This format for a list of monomial ideals has a lot of noise. We can
get a more compact notation by encoding each irreducible ideal as the
product of its generators, noting that this is a bijection between
irreducible ideals and monomials. Do this by typing
\begin{verbatim}
