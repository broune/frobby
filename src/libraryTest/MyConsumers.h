...
#include "../BigIdeal.h"
class MyIdealConsumer2 : public Frobby::IdealConsumer,
                         public MyConsumer {
public:
  MyIdealConsumer2(const VarNames& names);
...
class MyIdealsConsumer2 : public Frobby::IdealConsumer,
						 public MyConsumer {
public:
  MyIdealsConsumer2(const VarNames& names);
