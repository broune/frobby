...
vector<mpz_class> makeTerm(int a, int b, int c, int d) {
...
vector<BigIdeal> makeIrrdecomb_xx_yy_xz_yz() {
  ...
  ideals.push_back(makeb_x_y());
  ideals.push_back(makeb_xx_yy_z());
